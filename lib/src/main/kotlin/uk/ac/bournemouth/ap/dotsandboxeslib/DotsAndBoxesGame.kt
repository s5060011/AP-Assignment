...
interface DotsAndBoxesGame {
    //Get values from interface for squares no. to be inherited to abstract to normal
    // squX = 5, squY = 6 ==
    // linesX (horizontal) = 7 (1 top, 1 bottom, 5 middle (1 more than squ)),
    // linesY (vertical) = 6 (1 left, 1 right, 4 middle (1 more than squ))
    /**
